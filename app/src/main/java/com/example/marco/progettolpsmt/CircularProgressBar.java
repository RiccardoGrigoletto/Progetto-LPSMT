...
public class CircularProgressBar extends ProgressBar{
	...
	public void init(AttributeSet attrs, int style){
		...
		width = a.getDimensionPixelOffset(R.styleable.CircularProgressBar_circ_width,100);
        height = a.getDimensionPixelOffset(R.styleable.CircularProgressBar_circ_height,100);
		...
		mTitlePaint.setTextSize(height);
		...
		mSubtitlePaint.setTextSize(width);
	...
	public void animateProgressTo(final int start, final int end, final ProgressAnimationListener listener){
		...
		progressBarAnimator.setDuration(1500000);
